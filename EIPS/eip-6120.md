...
category: ERC
created: 2022-12-12
requires: 20, 721, 777, 1014, 1155, 1363
---
...
The contract call input `data` that starts with any of the following function selectors will be blocked from spending the token allowance:

* [ERC-20](./eip-20.md).transferFrom
* [ERC-721](./eip-721.md).transferFrom (same selector with ERC20)
* [ERC-721](./eip-721.md).safeTransferFrom (2 versions)
* [ERC-777](./eip-777.md).operatorSend
* [ERC-777](./eip-777.md).operatorBurn
* [ERC-1155](./eip-1155.md).safeTransferFrom
* [ERC-1155](./eip-1155.md).safeBatchTransferFrom
* [ERC-1363](./eip-1363.md).transferFromAndCall (2 versions)

Please refer to the [Non-standard Tokens](#non-standard-tokens) section in the **Security Considerations** for an important security note.
...
Token contracts with functions that spend the allowance, other than those defined by EIP-20, EIP-721, EIP-77, EIP-1155, and EIP-1363, must never be used with the UTR. Please refer to the [Blocked Functions](#blocked-functions) and [Non-standard Tokens](#non-standard-tokens).
...
The input `data` of actions using *transfer-from* function [selectors](#blocked-functions) of EIP-20, EIP-721, EIP-777, EIP-1155, and EIP-1363 are blocked by the UTR. Any token contract with functions that spend the token allowance other than those must never be approved to the UTR, as it would allow anyone to spend the entire allowance. New custom UTR contracts must be deployed to block those functions for non-standard tokens to be used.
